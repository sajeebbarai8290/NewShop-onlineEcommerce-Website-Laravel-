                ...
                <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                    <div class="grid-arr">
                        <div  class="grid-arrival">
                            <figure>		
                                <a href="{{route('product-details',['id'=>$newProduct->id,'name'=>$newProduct->product_name])}}" class="new-gri">
                                    <div class="grid-img">
                                        <img  src="{{asset($newProduct->product_image)}}"  alt="" height="300">
                                    </div>
                                    <div class="grid-img">
                                        <img  src="{{asset($newProduct->product_image)}}"  alt="" height="300">
                                    </div>			
                        ...
                        <div class="women">
                            ...
                            <a href="#" data-text="Add To Cart" class="my-cart-b item_add" onclick="document.getElementById('customerAddTOCartForm').submit();">Add To Cart</a>
                            {{Form::open(['route'=>'add-to-cart','method'=>'POST','id'=>'customerAddTOCartForm'])}}
