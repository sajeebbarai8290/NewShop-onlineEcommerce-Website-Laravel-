<div class="header">
            <div class="header-top">
                <div class="container">
                    <div class="top-left">
                        <a href="#"> Help  <i class="glyphicon glyphicon-phone" aria-hidden="true"></i> +0176844....</a>
                    </div>
                    <div class="top-right">
                        <ul>
                            <li>
                                @if(Session::get('customerId') && Session::get('shippingId'))
                                    <a href="{{route('checkout-payment')}}" >Checkout</a>
                                @elseif(Session::get('customerId'))
                                    <a href="{{route('new-shipping')}}">Checkout</a>
                                @else
